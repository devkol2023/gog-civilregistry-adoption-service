...
public interface ApplicationRegisterRepository extends JpaRepository<ApplicationRegisterEntity, Long> {
	...
	@Query(value = " SELECT \r\n"
			...
			+ "		        concat_ws(', ', tand.child_surname, concat_ws(' ', tand.child_first_name, tand.child_middle_name)) AS childName,\r\n"
			+ "		        concat_ws(', ', tand.mother_surname, concat_ws(' ', tand.mother_first_name, tand.mother_middle_name)) AS motherName,\r\n"
			+ "		        concat_ws(', ', tand.father_surname, concat_ws(' ', tand.father_first_name, tand.father_middle_name)) AS fatherName,\r\n"
